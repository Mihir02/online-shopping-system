...
VALUES (
    ...
    12,
    'support',
    'studentidrobert@gmail.com',
    'New York, Kumbalagodu, Karnataka',
    'New York',
    'Karnataka',
    560074,
    'pokjhgfcxc',
...
AFTER
INSERT ON `user_info` FOR EACH ROW BEGIN
...
INSERT INTO `wishlist` (`id`, `p_id`, `ip_add`, `user_id`)
VALUES (224, 0, '::1', -1),
  (282, 3, '::1', -1),
  (283, 73, '::1', 12),
  (284, 74, '::1', 12),
